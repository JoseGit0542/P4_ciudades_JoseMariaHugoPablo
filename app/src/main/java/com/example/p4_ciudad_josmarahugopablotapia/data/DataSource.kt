...
private val detalles = listOf(
    ...
    Detalle(17, R.string.vaca_seta_marron, R.drawable.vaca_seta_marron, R.string.desc_vaca_marron, BIOMA_SETAS, CAT_CRIATURAS),
    Detalle(18, R.string.micelio, R.drawable.micelio, R.string.desc_micelio, BIOMA_SETAS, CAT_VEGETACION),
    Detalle(28, R.string.sopa_setas, R.drawable.sopa_setas, R.string.desc_sopa_setas, BIOMA_SETAS, CAT_RECURSOS),
    // Taiga
    ...
    Detalle(19, R.string.zorro, R.drawable.zorro, R.string.desc_zorro, BIOMA_TAIGA, CAT_CRIATURAS),
    Detalle(20, R.string.bayas_dulces, R.drawable.bayas_dulces, R.string.desc_bayas_dulces, BIOMA_TAIGA, CAT_VEGETACION),
    Detalle(35,R.string.mansion_pillagers, R.drawable.mansion_pillagers, R.string.desc_mansion_pillagers, BIOMA_TAIGA, CAT_ESTRUCTURAS),
    Detalle(21, R.string.puesto_saqueadores, R.drawable.puesto_saqueadores, R.string.desc_puesto_saqueadores, BIOMA_TAIGA, CAT_ESTRUCTURAS),
    Detalle(29, R.string.iglu, R.drawable.iglu, R.string.desc_iglu, BIOMA_TAIGA, CAT_ESTRUCTURAS),
    Detalle(30, R.string.helecho, R.drawable.helecho, R.string.desc_helecho, BIOMA_TAIGA, CAT_VEGETACION),
    // Jungla
    ...
    Detalle(22, R.string.loro, R.drawable.loro, R.string.desc_loro, BIOMA_JUNGLA, CAT_CRIATURAS),
    Detalle(23, R.string.panda, R.drawable.panda, R.string.desc_panda, BIOMA_JUNGLA, CAT_CRIATURAS),
    Detalle(24, R.string.cacao, R.drawable.cacao, R.string.desc_cacao, BIOMA_JUNGLA, CAT_RECURSOS),
    Detalle(35, R.string.madera_jungla, R.drawable.madera_jungla, R.string.desc_madera_jungla, BIOMA_JUNGLA, CAT_RECURSOS),
    Detalle(31, R.string.sandia, R.drawable.sandia, R.string.desc_sandia, BIOMA_JUNGLA, CAT_VEGETACION),
    // Sabana
    ...
    Detalle(25, R.string.llama, R.drawable.llama, R.string.desc_llama, BIOMA_SABANA, CAT_CRIATURAS),
    Detalle(26, R.string.armadillo, R.drawable.armadillo, R.string.desc_armadillo, BIOMA_SABANA, CAT_CRIATURAS),
    Detalle(27, R.string.pasto_seco, R.drawable.pasto, R.string.desc_pasto_seco, BIOMA_SABANA, CAT_VEGETACION)
)
