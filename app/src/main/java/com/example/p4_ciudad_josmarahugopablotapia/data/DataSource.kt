...
object DataSource {
    ...
    fun obtenerDetalles(bioma: Int, categoria: Int): List<String> {
        return when (bioma to categoria) {
            ...
            // Campos de setas
            R.string.campos_setas to R.string.criaturas -> listOf("Mooshroom")
            ...
            R.string.campos_setas to R.string.vegetacion -> listOf("Setas gigantes", "Hierba alta")

            // Taiga
            R.string.taiga to R.string.criaturas -> listOf("Lobo", "Zorro")
            ...
            // Jungla
            R.string.jungla to R.string.criaturas -> listOf("Ocelote", "Panda")
            ...
            // Sabana
            R.string.sabana to R.string.criaturas -> listOf("Caballo", "Llama")
            ...
            // Bosque
            R.string.bosque to R.string.criaturas -> listOf("Lobo", "Zorro")
            R.string.bosque to R.string.estructuras -> listOf("Aldea Bosque")
            R.string.bosque to R.string.recursos -> listOf("Madera de roble", "Manzanas")
            R.string.bosque to R.string.vegetacion -> listOf("Robles", "Flores", "Hierba alta")
